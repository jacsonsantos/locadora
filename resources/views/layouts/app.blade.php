        ...
        <div class="main">
            <div class="row">
                <div class="side-menu" id="side-menu">
                    ...
                    <div class="menu">
                        <div class="menu-item filmes">Filmes</div>
                        ...
                        <div class="menu-item cliente">Cliente</div>
                        <div class="sub-cliente">
                                <div class="sub-item">Clientes</div>
                                <div class="sub-item">Cadastro</div>
                                <div class="sub-item">Pendente</div>
                        </div>
                        <div class="menu-item"><a href="#">Sair</a></div>
                    </div>
                </div>
