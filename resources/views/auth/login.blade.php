...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default" style="box-shadow: 0 3px 8px #333;">
                <div class="panel-heading" style="background-color: #008cff;color:#fff;">Entrar</div>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <button type="button" class="btn btn-danger" style="margin-left: 20px;" data-toggle="modal" data-target="#myModal">
                                    Criar Conta
                                </button>
